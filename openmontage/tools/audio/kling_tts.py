...
class KlingTTS(BaseTool):
    ...
    install_instructions = (
        ...
        "Pass voice_id explicitly; cutmax does not guess Kling voice IDs."
    )
        ...
        result.update(
            {
                ...
                "cost_estimate_basis": "Conservative character-based cutmax estimate pending official account-usage reconciliation.",
            }
        )
        return result
