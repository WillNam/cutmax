"""Bridge cutmax playbooks → HyperFrames-friendly style artifacts.

cutmax playbooks are YAML files describing visual_language, typography,
...
def _render_design_md(
    ...
    lines = [
        title,
        "",
        f"> Generated by cutmax HyperFrames style bridge (source: {source_note}).",
        "",
        "## Colors",
        "",
