...
cutmax is an open-source, AI-orchestrated video production platform.
...
Layer 2: skills/                    → "How cutmax uses them" (project conventions)
...
| `skills/core/hyperframes.md` | Layer 2 — when cutmax should pick HyperFrames vs Remotion, artifact → workspace mapping |
