"""检查 cutmax-moneyprinter 是否存在可用的新正式版本。"""
...
LATEST_RELEASE_API_URL: Final = (
    "https://api.github.com/repos/WillNam/cutmax/releases/latest"
)
LATEST_RELEASE_PAGE_URL: Final = (
    "https://github.com/WillNam/cutmax/releases/latest"
)
...
RELEASE_CHECK_HEADERS: Final = {
    ...
    "User-Agent": "cutmax-moneyprinter-Version-Checker",
}
...
def get_available_update(current_version: str) -> str | None:
    ...
    logger.info(
        "cutmax-moneyprinter update available: "
...
class AsyncUpdateChecker:
    ...
    def _run_check(self, current_version: str) -> None:
        try:
            ...
            logger.exception(
                "unexpected error while checking for a cutmax-moneyprinter update"
            )
