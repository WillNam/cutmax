...
def load_config():
    # fix: IsADirectoryError: [Errno 21] Is a directory: '/cutmax-moneyprinter/config.toml'
...
project_name = _cfg.get("project_name", "cutmax-moneyprinter")
project_description = _cfg.get(
    "project_description",
    "<a href='https://github.com/WillNam/cutmax'>https://github.com/WillNam/cutmax</a>",
)
